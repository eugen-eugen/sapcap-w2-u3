...
const _4sqlite = global.cds.env.i18n ? global.cds.env.i18n.for_sqlite || [] : []
const localized = []
...
const draftIsLocked = lastChangedAt => {
  ...
  const DRAFT_CANCEL_TIMEOUT =
    (global.cds.env.drafts && global.cds.env.drafts['cancellation-timeout']) || 15 * 1000 * 60
  return DRAFT_CANCEL_TIMEOUT > Date.now() - Date.parse(lastChangedAt)
}
